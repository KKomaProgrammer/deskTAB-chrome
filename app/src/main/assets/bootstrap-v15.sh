...
REPAIR_COMMIT="f2f2ebae3db78940ede494527d708c09b30ced99"
BASE="https://raw.githubusercontent.com/KKomaProgrammer/deskTAB-chrome/$INSTALLER_COMMIT/installer/v10"
REPAIR_URL="https://raw.githubusercontent.com/KKomaProgrammer/deskTAB-chrome/$REPAIR_COMMIT/installer/repair-v15.sh"
...
REPAIR="$INSTALLER_DIR/desktop-repair-v15.sh"
...
# A valid rootfs is the source of truth. Do not depend on stale Android/Termux ready markers.
RUNTIME_HEALTHY=1
for ROOT in \
